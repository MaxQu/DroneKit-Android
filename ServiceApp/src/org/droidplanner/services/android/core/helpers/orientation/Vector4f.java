...
public class Vector4f {
    ...
    public float getNorm() {
        return (float) Math.sqrt(points[0] * points[0] + points[1] * points[1] + points[2] * points[2] + points[3] * points[3]);
    }
